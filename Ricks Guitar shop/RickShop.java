...
public class RickShop {
        ...
        public static void main(String[] args) {
                ...
                if (gl.size() > 0) {
                        ...
                        for (Guitar g : gl) {
                                System.out.println(g.getSpec().builder + " " + g.getSpec().model + " "
                                                + g.getSpec().type + " "
                                                + g.getSpec().numStrings + " " + g.getSpec().topWood + " "
                                                + g.getSpec().backWood);
        ...
        public static void initializeInventory(Inventory inventory) {
                ...
                Mandolin m;
                m = new Mandolin("11277", 3999.95,
                                new MandolinSpec(Builder.COLLINGS, "CJ", Type.ACOUSTIC, Wood.INDIAN_ROSEWOOD,
                                                Wood.SITKA, Style.A));
                inventory.addMandolin(m);
                m = new Mandolin("V95693", 1499.95,
                                new MandolinSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER,
                                                Wood.ALDER, Style.F));
                inventory.addMandolin(m);
                m = new Mandolin("V9512", 1549.95,
                                new MandolinSpec(Builder.FENDER, "Stratocastor", Type.ELECTRIC, Wood.ALDER,
                                                Wood.ALDER, Style.F));
                inventory.addMandolin(m);
